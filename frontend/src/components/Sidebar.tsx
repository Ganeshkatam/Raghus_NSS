...
export const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose }) => {
  const { isAdmin, isCoordinatorOrOfficer, isVolunteer } = useAuth();
        ...
        <nav className="sidebar-nav">
          ...
          <div className="nav-group">
            ...
            >
              ...
              <span>{isVolunteer && !isCoordinatorOrOfficer ? "My NSS" : "Overview"}</span>
            </NavLink>
          </div>
          ...
          {/* Section: Administration (Separated toward the bottom) */}
          {isAdmin && (
